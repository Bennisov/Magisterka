...
#
# Script generated by Vivado on Fri Oct 03 16:03:49 CEST 2025
# SW Build 6140274 on Wed May 21 22:58:25 MDT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : axi_register_verification.sh
...
#
# Usage        : axi_register_verification.sh
#                axi_register_verification.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                axi_register_verification.sh [-reset_run]
#                axi_register_verification.sh [-reset_log]
#                axi_register_verification.sh [-help]
#
...
#                script (type 'axi_register_verification.sh -help' for more information).
#
...
design_libs_elab="-libname xilinx_vip -libname axi_infrastructure_v1_1_0 -libname xil_defaultlib -libname axi_vip_v1_1_21 -libname xilinx_vip -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xilinx_vip axi_infrastructure_v1_1_0 xil_defaultlib axi_vip_v1_1_21)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "axi_register_verification.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./axi_register_verification.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"../../../../FPGA.gen/sources_1/bd/axi_register_verification/ipshared/ec67/hdl" +incdir+"../../../../../../../../../Xilinx/2025.1/data/rsb/busdef" +incdir+"/storage/Xilinx/2025.1/Vivado/data/xilinx_vip/include" \
  ...
  xmvlog -work axi_infrastructure_v1_1_0 $xmvlog_opts +incdir+"../../../../FPGA.gen/sources_1/bd/axi_register_verification/ipshared/ec67/hdl" +incdir+"../../../../../../../../../Xilinx/2025.1/data/rsb/busdef" +incdir+"/storage/Xilinx/2025.1/Vivado/data/xilinx_vip/include" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts -sv +incdir+"../../../../FPGA.gen/sources_1/bd/axi_register_verification/ipshared/ec67/hdl" +incdir+"../../../../../../../../../Xilinx/2025.1/data/rsb/busdef" +incdir+"/storage/Xilinx/2025.1/Vivado/data/xilinx_vip/include" \
  "../../../bd/axi_register_verification/ip/axi_register_verification_axi_vip_0_0/sim/axi_register_verification_axi_vip_0_0_pkg.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_vip_v1_1_21 $xmvlog_opts -sv +incdir+"../../../../FPGA.gen/sources_1/bd/axi_register_verification/ipshared/ec67/hdl" +incdir+"../../../../../../../../../Xilinx/2025.1/data/rsb/busdef" +incdir+"/storage/Xilinx/2025.1/Vivado/data/xilinx_vip/include" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../FPGA.gen/sources_1/bd/axi_register_verification/ipshared/ec67/hdl" +incdir+"../../../../../../../../../Xilinx/2025.1/data/rsb/busdef" +incdir+"/storage/Xilinx/2025.1/Vivado/data/xilinx_vip/include" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.axi_register_verification xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.axi_register_verification -input simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/storage/moron/Projects/GutsyFerret/REPOSITORIES/GF_Pawlak/FPGA.cache/compile_simlib/xcelium"
  fi
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log axi_register_verification_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./axi_register_verification.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: axi_register_verification.sh [-help]\n\
Usage: axi_register_verification.sh [-step]\n\
Usage: axi_register_verification.sh [-lib_map_path]\n\
Usage: axi_register_verification.sh [-reset_run]\n\
Usage: axi_register_verification.sh [-reset_log]\n\
Usage: axi_register_verification.sh [-keep_index]\n\
Usage: axi_register_verification.sh [-noclean_files]\n\n\
