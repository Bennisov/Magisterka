...
design_libs=(xilinx_vip axi_infrastructure_v1_1_0 xil_defaultlib axi_vip_v1_1_21)
...
compile()
{
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"../../../../FPGA.gen/sources_1/bd/axi_register_verification/ipshared/ec67/hdl" +incdir+"../../../../../../../../../Xilinx/2025.1/data/rsb/busdef" +incdir+"/storage/Xilinx/2025.1/Vivado/data/xilinx_vip/include" \
  ...
  vlogan -work axi_infrastructure_v1_1_0 $vlogan_opts +v2k +incdir+"../../../../FPGA.gen/sources_1/bd/axi_register_verification/ipshared/ec67/hdl" +incdir+"../../../../../../../../../Xilinx/2025.1/data/rsb/busdef" +incdir+"/storage/Xilinx/2025.1/Vivado/data/xilinx_vip/include" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts -sverilog +incdir+"../../../../FPGA.gen/sources_1/bd/axi_register_verification/ipshared/ec67/hdl" +incdir+"../../../../../../../../../Xilinx/2025.1/data/rsb/busdef" +incdir+"/storage/Xilinx/2025.1/Vivado/data/xilinx_vip/include" \
  "../../../bd/axi_register_verification/ip/axi_register_verification_axi_vip_0_0/sim/axi_register_verification_axi_vip_0_0_pkg.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work axi_vip_v1_1_21 $vlogan_opts -sverilog +incdir+"../../../../FPGA.gen/sources_1/bd/axi_register_verification/ipshared/ec67/hdl" +incdir+"../../../../../../../../../Xilinx/2025.1/data/rsb/busdef" +incdir+"/storage/Xilinx/2025.1/Vivado/data/xilinx_vip/include" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../FPGA.gen/sources_1/bd/axi_register_verification/ipshared/ec67/hdl" +incdir+"../../../../../../../../../Xilinx/2025.1/data/rsb/busdef" +incdir+"/storage/Xilinx/2025.1/Vivado/data/xilinx_vip/include" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.axi_register_verification xil_defaultlib.glbl -o axi_register_verification_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./axi_register_verification_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/storage/moron/Projects/GutsyFerret/REPOSITORIES/GF_Pawlak/FPGA.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key axi_register_verification_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc axi_register_verification_simv.daidir vcs_lib c.obj)
