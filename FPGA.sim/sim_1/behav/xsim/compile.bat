...
REM
REM Generated by Vivado on Tue Sep 30 17:42:25 +0200 2025
...
echo "xvlog --incr --relax -L uvm -prj tb_registerv2_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_registerv2_vlog.prj -log xvlog.log
