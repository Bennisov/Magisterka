...
//Command     : generate_target Regx32_veri.bd
//Design      : Regx32_veri
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "Regx32_veri,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=Regx32_veri,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=2,numReposBlks=2,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,synth_mode=Hierarchical}" *) (* HW_HANDOFF = "Regx32_veri.hwdef" *) 
module Regx32_veri
   (aclk,
    aresetn,
    data_output);
  ...
  Regx32_veri_axi_vip_0_0 axi_vip_0
       (.aclk(aclk),
        .aresetn(aresetn),
