...
//Date        : Wed Nov  5 09:57:15 2025
//Host        : LAPTOP-H5N3SV97 running 64-bit major release  (build 9200)
//Command     : generate_target RegSRx8_veri.bd
//Design      : RegSRx8_veri
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "RegSRx8_veri,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=RegSRx8_veri,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=2,numReposBlks=2,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,synth_mode=Hierarchical}" *) (* HW_HANDOFF = "RegSRx8_veri.hwdef" *) 
module RegSRx8_veri
   (aclk,
    aresetn,
    resetuj,
  ...
  RegSRx8_veri_RegSRx8_0_0 RegSRx8_0
       (.resetuj(resetuj),
        .s00_axi_aclk(aclk),
        ...
        .setuj(setuj),
        .slv_regs(slv_regs));
  RegSRx8_veri_axi_vip_0_0 axi_vip_0
       (.aclk(aclk),
        .aresetn(aresetn),
