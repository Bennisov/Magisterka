...
//Command     : generate_target RegRx8_veri.bd
//Design      : RegRx8_veri
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "RegRx8_veri,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=RegRx8_veri,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=2,numReposBlks=2,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,synth_mode=Hierarchical}" *) (* HW_HANDOFF = "RegRx8_veri.hwdef" *) 
module RegRx8_veri
   (aclk,
    aresetn,
    resetuj,
  ...
  RegRx8_veri_RegRx8_0_0 RegRx8_0
       (.resetuj(resetuj),
        .s00_axi_aclk(aclk),
        ...
        .slv_regs(slv_regs));
  RegRx8_veri_axi_vip_0_0 axi_vip_0
       (.aclk(aclk),
        .aresetn(aresetn),
