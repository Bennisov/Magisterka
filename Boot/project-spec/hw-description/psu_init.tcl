...
set psu_clock_init_data {
    ...
    mask_write 0XFF5E00C8 0x013F3F07 0x01010C02
		# Register : AMS_REF_CTRL @ 0XFF5E0108</p>
...
set psu_ddr_init_data {
    ...
    mask_write 0XFD070104 0x001F1F7F 0x0004041E
...
set psu_mio_init_data {
    ...
    mask_write 0XFF180204 0x7FFFFFFF 0x2C000000
    ...
    mask_write 0XFF18015C 0x03FFFFFF 0x0001300B
    ...
    mask_write 0XFF180168 0x03FFFFFF 0x03F23004
...
set psu_peripherals_init_data {
    ...
    mask_write 0XFF0A0244 0x03FFFFFF 0x00000010
		# : DIR MODE BANK 2
    ...
    mask_write 0XFF0A0248 0x03FFFFFF 0x00000010
