...
proc create_ipi_design { offsetfile design_name } {
	...
	# Create instance: IP_set_reset_0, and set properties
	set IP_set_reset_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:IP_set_reset:1.0 IP_set_reset_0 ]
	...
	# Connect all clock & reset of IP_set_reset_0 slave interfaces..
	connect_bd_intf_net [get_bd_intf_pins axi_peri_interconnect/M00_AXI] [get_bd_intf_pins IP_set_reset_0/ip_setreset]
	connect_bd_net [get_bd_pins IP_set_reset_0/ip_setreset_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins IP_set_reset_0/ip_setreset_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]


	# Auto assign address
	assign_bd_address

	# Copy all address to IP_set_reset_include.tcl file
	set bd_path [get_property DIRECTORY [current_project]]/[current_project].srcs/[current_fileset]/bd
	upvar 1 $offsetfile offset_file
	set offset_file "${bd_path}/IP_set_reset_include.tcl"
	set fp [open $offset_file "w"]
	puts $fp "# Configuration address parameters"

	set offset [get_property OFFSET [get_bd_addr_segs /jtag_axi_0/Data/SEG_IP_set_reset_0_ip_setreset_* ]]
	puts $fp "set ip_setreset_addr ${offset}"

	close $fp
}

# Set IP Repository and Update IP Catalogue 
set ip_path [file dirname [file normalize [get_property XML_FILE_NAME [ipx::get_cores xilinx.com:user:IP_set_reset:1.0]]]]
set hw_test_file ${ip_path}/example_designs/debug_hw_design/IP_set_reset_hw_test.tcl
...
for { set i 1 } { 1 } { incr i } {
	set design_name "IP_set_reset_hw_${i}"
